...
subcategoriesPath.collection = 'content/subcategoriesCity';
...
gulp.task('md:subcategoriesCity', function() {
...
gulp.task('del:subcategoriesCity', function () {
  return del([
    ...
    'content/subcategoriesCity/**/*'
  ]);
});

gulp.task('create:subcategoriesCity', gulpSequence(
    'del:subcategoriesCity',
    'md:subcategoriesCity',
    ));

gulp.task('recreate:subcategoriesCity', gulpSequence(
    'del:subcategoriesCity',
    'md:subcategoriesCity',
    ));